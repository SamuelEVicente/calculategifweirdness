...
const Gif = (props) => {
  const unLikeable = props.onUnlikeGif ? <Button data-test="Gif-Unlike" id={props.gif.id} onClick={e => props.onUnlikeGif(e)}><AiFillDislike /> </Button> : null;
  return (
